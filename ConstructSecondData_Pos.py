...
if __name__ == "__main__":
    #### file path
    effiWeight = "./Model_Weight/Model_EFb7_TEST_0.908.pth"   ### change here
    CSV = "./CSVFile/augPos" \
          ".csv"
    imgFiles = "./PosTrainAugResize"
    ### name string
    modelName = "b7"
    outputName = "_TEST_0.908_Pos"  ### change here
    ...
    if if_test is False:
        ...
        try:
            ...
            dataframe = pd.DataFrame(dataframeMap).to_csv("./CSVFile/Pos/Effi" + modelName + outputName + ".csv",
                                                          index=False)
        except KeyError:
            imgN, effiR = constructEffiData(effiWeight, CSV, imgFiles, model_name=modelName)
            dataframeMap = {"image_name": imgN,
